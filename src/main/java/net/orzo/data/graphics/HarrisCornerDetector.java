...
public class HarrisCornerDetector implements FeaturePointDetector {
	 ...
	 * 
	 * @param dmin
	 *            radius where to select single feature point
	 */
	 ...
	 * 
	 * @param list
	 *            of all found corners (according to provided threshold)
	 * @param dmin
	 *            range (in px) in which all worse corners around the best ones
	 *            will be removed
	...
	private List<CornerPoint> cleanupCorners(List<CornerPoint> corners,
		...
		CornerPoint[] cornerArray = corners.toArray(new CornerPoint[corners
				.size()]);
		List<CornerPoint> outCorners = new Vector<CornerPoint>(corners.size());
	 ...
	 * @param dataLineWidth
	 *            width of image represented by the data parameter
	 * @param kernel
	 *            vector
	 ...
	 * 
	 * @param dataA
	 *            the I^2_x(u, v) matrix
	 * @param dataB
	 *            the I^2_y(u, v) matrix
	 * @param dataC
	 *            the I_x(u, v)I_y(u, v) matrix
